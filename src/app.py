...
def main():
    ...
    st.set_page_config(page_title='Telemarketing analysis',
                       page_icon='images/telemarketing_icon.png',
                       layout='wide',
    ...
    st.write('## To Start')
    st.write('Please upload a file with the sidebar options.')

    st.sidebar.image(Image.open('images/Bank-Branding.jpg'))
    ...
    if fp is not None:
        ...
        with st.sidebar.form(key='filter_form'):
            ...
            st.write('### Customize column filter')
